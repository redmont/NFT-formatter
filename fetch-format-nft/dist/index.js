    ...
    function OpenSeaClient(props) {
        ...
        this.getTransferredCollectiblesForWallet = function (wallet, limit) {
            ...
            return __awaiter(_this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, fetch(this.url + "/events?account_address=" + wallet + "&limit=" + limit + "&event_type=transfer&only_opensea=false", this.requestOptions).then(function (r) { return r.json(); })];
                });
            });
        };
        ...
        this.getCreatedCollectiblesForWallet = function (wallet, limit) {
            ...
            return __awaiter(_this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, fetch(this.url + "/events?account_address=" + wallet + "&limit=" + limit + "&event_type=created&only_opensea=false", this.requestOptions).then(function (r) { return r.json(); })];
                });
            });
        };
        ...
        this.getCollectiblesForWallet = function (wallet, limit) {
            ...
            return __awaiter(_this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, fetch(this.url + "/assets?owner=" + wallet + "&limit=" + limit, this.requestOptions).then(function (r) { return r.json(); })];
                });
            });
        };
